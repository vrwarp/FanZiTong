...
| **Mode 1 · Rapid recognition** (§5.1)   | Large Traditional prompt, domain tag, tap-to-reveal pinyin/definition/example sentence, four FSRS rating buttons showing the exact next interval computed by `ts-fsrs`. Each character chip says whether the learner has read it in another word ("read in 滷肉飯", "missed in 滷味", "new here"). Keyboard shortcuts (space, 1–4). Optional auto-reveal delay.                                                                                                                                                                                                                                                                                                        |

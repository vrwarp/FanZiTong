...
- The reveal for this learner: "How well did you _read_ it?" with latency and rubric (03, 21b, 24); "ô-á-tsian · kē zǎi jiān" with its one-line note (21b); variant lines that are true per card and definitions that are only meaning (24); chips that show a character's other words on tap and underline it in the sentence (03b).

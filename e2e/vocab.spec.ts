...
test.describe('Vocab tab: import, export, edit (Journey 2, AC-3)', () => {
  ...
  test('exports JSON and CSV with intact Traditional characters', async ({ page }) => {
    ...
    expect(csv.slice(1).split('\n')[0]).toBe(
      'traditional,pinyin,definition,domain,tags,example_sentence,foils,example_pinyin,example_translation,variants,spoken,variant_note,cloze_distractors,notes,homophones,extra_sentences,extra_pinyin,extra_translations',
    );

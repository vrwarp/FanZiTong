...
const SNACK_RE =
  /(煎|圓|雞|豆腐|甜不辣|包小腸|粿|嗲|排|串|餃|粽|薯條|羹|香腸|關東煮|胡椒餅|酥|抄手)/;
const FRUIT_RE =
  /(瓜|果|梨|蕉|桃|柚|旦|椰|檸|莓|栗|李|柿|柑|龍眼|山竹|石榴|葡萄|荔枝|蓮霧|釋迦|芭樂|柳丁|番茄|水果)/;
...
const SWEET_RE =
  /(糖|糕|凍|布丁|甜點|點心|冰淇淋|巧克力|愛玉|仙草|月餅|老婆餅|麻糬|豆花|甜甜圈|甜筒|羊羹|冰)/;
/**
